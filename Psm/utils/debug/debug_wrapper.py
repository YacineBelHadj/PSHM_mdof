...
def debug_wrapper(logging_level: int):
    ...
    for function wrappers with logging purposes. It wraps the target
    ...
    Args:
        logging_level: The logging level for logging messages. The
    ...
    def _debug_wrapper(func: Callable) -> Callable:
        ...
        def _func_with_debug_wrapper(*args, **kwargs) -> Any:
            ...
            _function_arg_dict = {
                **dict(zip(_func_arg_names, args + _func_default_args)),
                **kwargs,
            }
